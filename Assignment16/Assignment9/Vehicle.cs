...
{      
    class Vehicle
    {
        ...
        private const string VehiclOverHeated = "Vehicle is overheated, Time:  {0} , Speed: {1} Speed";
        private const string VehicltooSlow = "Vehicle is Too Slow";
        /// <summary>
        /// Default costructor 
        /// </summary>
        ...
        public float Speed
        {
            ...
            set
            {
                throwExceptionVehicleOverHeated(value);
                _speed = value;
            }
        }
       ...
       /// </summary>
        ...
        {            
            Speed = Speed + speed;
            throwExceptionVehicleOverHeated(Speed);
        ...
        {
            Speed = Speed - speed;
            throwExceptionVehicleSlow(Speed);
        }

        /// <summary>
        /// Method to thow exception if vehicle is over heated
        /// </summary>
        /// <param name="Speed">Speed of the vehicle</param>
        public void throwExceptionVehicleSlow(float Speed)
        {
          if (Speed <= 10)
            {
                throw new IsCarDeadException(VehicltooSlow);
            }
        }
        ...
        /// Method to thow exception if vehicle is over heated
        /// </summary>
        /// <param name="Speed">Speed of the vehicler</param>
        public void throwExceptionVehicleOverHeated(float Speed)
        {
            if (Speed >= 500)
            {
                throw new IsCarDeadException(string.Format(VehiclOverHeated, DateTime.Now.ToString(), Speed));                
            }
